...
public class FolderController {
    ...
    public ResponseEntity<List<FolderShortResponse>> listMasterFolders(){
        return ResponseEntity.status(HttpStatus.CREATED).body(folderFacade.listMasterFolders());
    }
    ...
    public ResponseEntity<FolderResponse> listContent(@PathVariable Long id,
